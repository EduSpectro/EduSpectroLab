...
内容の確認以前読み取った画像データに基づき、各数値を配置しています。1行目: シリアル番号   2行目 ($A_0$): 305.09852113行目 ($B_1$): 2.7251041354行目 ($B_2$): -0.0015111882615行目 ($B_3$): -4.541618153E-66行目 ($B_4$): -2.920135258E-97行目 ($B_5$): 2.233048692E-11この内容をコピーして
